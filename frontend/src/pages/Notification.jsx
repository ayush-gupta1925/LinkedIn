        ...
        <div className="w-full max-w-[900px] flex flex-col gap-3 sm:gap-4">
          {notificationData.map((noti, index) => {
            ...
            return (
              <div
                key={id}
                className="w-full bg-white shadow rounded-lg p-3 sm:p-4 flex flex-col sm:flex-row gap-3 sm:gap-4 hover:shadow-md transition-shadow"
              >
                {/* Left: Avatar + Info */}
                <div
                  className="flex items-start gap-3 flex-1 cursor-pointer"
                ...
                >
                  ...
                  <div className="flex-1 min-w-0 flex flex-col gap-1 sm:gap-2">
                    ...
                    <div className="flex items-center justify-between gap-2">
                      ...
                      {/* Close Button aligned to the right with gap */}
                      <RxCross2
                        className="text-lg sm:text-xl md:text-2xl text-gray-800 cursor-pointer hover:text-red-500 flex-shrink-0 ml-2"
                        onClick={() => handledeleteOneNotification(id)}
                      />
                    </div>
